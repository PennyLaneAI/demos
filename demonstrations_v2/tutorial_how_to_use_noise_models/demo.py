...
# module to construct and manipulate noise models, enabling noisy simulation (see the :doc:`noise module documentation </code/qp_noise>` for more details). In PennyLane,
