...
`fermionic operator <https://pennylane.ai/demos/tutorial_fermionic_operators>`__,
...
# `qubit tapering <https://pennylane.ai/demos/tutorial_qubit_tapering>`__ demo.
...
# compute its ground state energy with the `VQE <https://pennylane.ai/demos/tutorial_vqe/>`__
# method.
#
# Energy Calculation
# ------------------
