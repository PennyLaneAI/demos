...
######################################################################
# Any differentiable loss function expressible in `JAX <https://pennylane.ai/demos/tutorial_jax_transformations>`__ can be defined, but must have a first argument
