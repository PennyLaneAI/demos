...
or `qubitization <https://pennylane.ai/demos/tutorial_qubitization>`_.

We begin with the example of `X-ray Absorption Spectroscopy (XAS) <https://pennylane.ai/demos/tutorial_xas>`_, using
PennyLane's resource :mod:`estimator <pennylane.estimator>` to quantify the resource requirements.

X-Ray Absorption Spectroscopy
-----------------------------
`XAS <https://pennylane.ai/demos/tutorial_xas>`_ is a spectroscopic method used to study the electronic
...
which utilizes the `Compressed Double-Factorization (CDF) <https://pennylane.ai/demos/tutorial_how_to_build_compressed_double_factorized_hamiltonians>`_
...
#
# To do the filtering, we will use `generalized quantum signal processing (GQSP) <https://pennylane.ai/demos/tutorial_estimator_hamiltonian_simulation_gqsp>`_,
...
##################################################################
# We now construct the `walk operator from the Hamiltonian <https://pennylane.ai/demos/tutorial_re_for_qubitizedQPE>`_
...
# <https://pennylane.ai/demos/tutorial_re_for_qubitizedQPE>`_ demo.
...
# `qubitization demo <https://pennylane.ai/demos/tutorial_re_for_qubitizedQPE>`_, or even by trying to use
