...
Looking for ways to leverage the speed of the `quantum Fourier transform <https://pennylane.ai/demos/tutorial_qft/>`__ is a common way to design quantum algorithms with exponential speed ups over classical algorithms. 
...
The quantum analogue of the discrete Chebyshev transform, the quantum Chebyshev transform, inherits the relation to the Fourier transform, allowing the transform to be designed efficiently by utilizing the `quantum Fourier transform <https://pennylane.ai/demos/tutorial_qft/>`__. Next we will discuss the quantum Chebyshev basis, where the Chebyshev polynomials appear in the state amplitudes.
...
Notice the use of the `quantum Fourier transform (QFT) <https://pennylane.ai/demos/tutorial_qft/>`__ applied on all qubits. 
