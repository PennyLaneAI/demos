...
# the model to overfit the data. This is also strictly related to the `repeated encoding <https://pennylane.ai/demos/tutorial_expressivity_fourier_series/>`__ of classical
...
# conditional statement. See this `demo <https://pennylane.ai/demos/tutorial_How_to_optimize_QML_model_using_JAX_and_JAXopt/>`__
