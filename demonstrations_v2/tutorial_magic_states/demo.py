...
# 3. **Check:** Perform a syndrome measurement by measuring certain `stabilizers <https://pennylane.ai/demos/tutorial_stabilizer_codes>`__
...
#
# See this `demo <https://pennylane.ai/demos/tutorial_magic_state_distillation>`__ 
...
# to :math:`10^{-9}` reducing the `spacetime <https://pennylane.ai/demos/tutorial_active_volume>`__ 
...
#    `lattice surgery <https://pennylane.ai/demos/tutorial_lattice_surgery>`__.
