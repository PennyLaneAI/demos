...
.. note:: 
    ...
    For more details, see the note in the "Lie algebras" section of our :ref:`Intro to (dynamical) Lie algebras for quantum practitioners <tutorial-liealgebra-lie-algebras>`.
