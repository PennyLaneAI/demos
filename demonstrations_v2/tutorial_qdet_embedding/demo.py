...
# that is compatible with PennyLane. Here's how to construct the `qubit Hamiltonian <https://pennylane.ai/demos/tutorial_fermionic_operators>`__:
#
# .. code-block:: python
#
...
#
# We can use this Hamiltonian in a quantum algorithm such as `quantum phase estimation (QPE) <https://pennylane.ai/demos/tutorial_qpe>`__.
...
# core-level excited states relevant to `X-ray Absorption Spectroscopy (XAS) <https://pennylane.ai/demos/tutorial_xas>`__.
