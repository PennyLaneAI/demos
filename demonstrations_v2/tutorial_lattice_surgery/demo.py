...
For self-consistency, we are going to briefly recap the basic concepts of the :doc:`rotated surface code <demos/surface-code>` and explain why `Pauli product measurements <https://pennylane.ai/compilation/pauli-based-computation>`__ are sufficient 
